...
const Like = () => {
  const [like, setLike] = useState(setLikeOnclick);
  const setLikeOnclick = (e) => {
    e.preventDefault();
    setLike(!like);
  }
  return (
    <div>
      <svg className="likeSvg" width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
